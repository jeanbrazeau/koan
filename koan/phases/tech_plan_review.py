    ...
    if step == 2:
        return StepGuidance(
            ...
            instructions=[
                ...
                "",
                "- **All internal** -> rewrite tech-plan.md in place. For targeted fixes,",
                "  prefer `koan_artifact_edit(filename=\"tech-plan.md\", old_string=...,",
                "  new_string=...)` for each change. For extensive rewrites, use",
